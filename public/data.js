...
export const stops = [
  ...
  {n:"Miami",lon:-80.1300,lat:25.7906,v:"Hard Rock Stadium",date:"Jun 21",match:"Uruguay 2–2 Cape Verde",note:"spotted live on the broadcast",f1:"🇺🇾",f2:"🇨🇻"}
];

// Great-circle miles for each leg between consecutive stops (length = stops - 1).
export const legMiles = [296,1291,313,822,2804,2732,966,1367,649,755,2459,2501,1592,405,1101,607];
...
export const co2Steps = [
  ...
  {t:58,m:"That&rsquo;s the carbon a gas car makes over ~150,000 miles &mdash; for 20,000 of flying"}
];
