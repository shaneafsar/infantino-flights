...
describe("distances", () => {
  ...
  test("totalMiles is the sum of legs (~35,788)", () => {
...
describe("CO2 model", () => {
  test("full tour is ~311 tonnes", () => {
    expect(totalMiles * CO2_PER_MILE).toBeCloseTo(311.4, 1);
  });
