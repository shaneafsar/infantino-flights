...
describe("flight cost", () => {
  ...
  test("full tour is ~$1.05M", () => {
    ...
    expect(cost).toBeLessThan(1110000);
  });
});
...
describe("CO2 model", () => {
  test("full tour is ~336 tonnes", () => {
    expect(totalMiles * CO2_PER_MILE).toBeCloseTo(335.7, 1);
  });
