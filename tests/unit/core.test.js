...
describe("itinerary data integrity", () => {
  test("36 stops, 35 legs", () => {
    expect(stops.length).toBe(36);
...
describe("distances", () => {
  ...
  test("totalMiles is the sum of legs (~42,968)", () => {
...
describe("CO2 model", () => {
  test("full tour is ~374 tonnes", () => {
    expect(totalMiles * CO2_PER_MILE).toBeCloseTo(373.8, 1);
  });
